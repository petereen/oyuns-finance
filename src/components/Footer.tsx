        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-12">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex items-center gap-3">
              <a href="https://t.me/oyuns_alo" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-full bg-white/5 hover:bg-blue-500/20 border border-white/10 hover:border-blue-400/30 flex items-center justify-center transition-all duration-200 group">
              ...
              <a href="https://www.facebook.com/oyuns.aio" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-full bg-white/5 hover:bg-blue-500/20 border border-white/10 hover:border-blue-400/30 flex items-center justify-center transition-all duration-200 group">
                <svg className="w-4 h-4 text-slate-400 group-hover:text-blue-400 transition-colors" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                </svg>
              </a>
              <a href="https://www.instagram.com/oyuns.finance/" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-full bg-white/5 hover:bg-pink-500/20 border border-white/10 hover:border-pink-400/30 flex items-center justify-center transition-all duration-200 group">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li>
                <a href="https://www.google.com/maps/place/OYUNS+ALL-IN-ONE/@47.9143833,106.9123287,807m/data=!3m2!1e3!4b1!4m6!3m5!1s0x5d969300484077cb:0x5783b60e41255746!8m2!3d47.9143797!4d106.9149036!16s%2Fg%2F11z7ksdcdz" target="_blank" rel="noopener noreferrer" className="flex items-start gap-2.5 text-slate-400 transition-colors hover:text-white">
                  <span className="grid h-8 w-8 shrink-0 place-items-center rounded-lg bg-white/5 text-blue-400">
                  ...
                  <span className="pt-1 leading-relaxed">{lang === 'ru' ? 'Монголия, г. Улан-Батор, район Сүхбаатар, проспект Чингис хаана, телебашня Монгол ТВ, здание группы «Алтай», 2-й этаж.' : 'Монгол Улс, Улаанбаатар хот, Сүхбаатар дүүрэг, Чингисийн өргөн чөлөө, Монгол ТВ цамхаг, Алтай группын байр, 2 давхар.'}</span>
                </a>
              </li>
              <li>
                <a href="tel:+97672000013" className="text-slate-400 hover:text-white transition-colors flex items-center gap-2.5">
