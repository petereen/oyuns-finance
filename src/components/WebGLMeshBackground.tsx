...
const shaderColors = new Float32Array([
  0x1b / 255, 0x40 / 255, 0xa8 / 255,
  0x2d / 255, 0x62 / 255, 0xec / 255,
  0x3d / 255, 0x6d / 255, 0xe5 / 255,
...
export default function WebGLMeshBackground() {
  ...
  useEffect(() => {
    ...
    gl.uniform4f(shapeLocation, 1.3, 0.56, 0.67, 0.19);
    gl.uniform4f(surfaceLocation, 2.02, 1.17, 0.0, 1.0);
    gl.uniform4f(finishLocation, 0.0, 0.3, 0.007, 0.1);
    gl.uniform4f(transformLocation, 5069.0, 2.72, 0.15, 0.0);
    gl.uniform4f(spaceLocation, 0.09, 0.15, 0.0, 0.0);
    gl.uniform4f(cursorLocation, 0.0, 2.0, 0.65, 0.46);
    ...
    const draw = (time: number) => {
      gl.uniform4f(sceneLocation, canvas.width, canvas.height, time * -1.37, 4.0);
