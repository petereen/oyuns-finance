      ...
      <div className="relative z-10 flex flex-col flex-1">
        ...
        {link && (
          <a
            ...
            className="mt-auto inline-flex items-center justify-center w-full bg-gradient-to-r from-[#2455D8] to-[#3d6de5] text-white px-6 py-3 rounded-full hover:shadow-lg hover:shadow-blue-900/25 hover:-translate-y-0.5 active:translate-y-0 transition-all duration-200 font-medium text-sm"
          >
