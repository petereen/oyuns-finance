...
export default function Home() {
  ...
  const [directusTestimonials, setDirectusTestimonials] = useState<
    Testimonial[]
  >([]);
  ...
  useEffect(() => {
    async function fetchData() {
      try {
        const [services, testimonials, rate, bizRate, partnerData, posts] =
          await Promise.all([
            getServices().catch(() => []),
        ...
        if (testimonials.length)
          setDirectusTestimonials(testimonials as Testimonial[]);
  ...
  const t = {
    mn: {
      ...
      about_text_1: (
        <>
          <strong className="text-slate-900">OYUNS ALL-IN-ONE</strong> нь 2018
          оноос эхлэн олон улсын мөнгөн гуйвуулга, санхүүгийн үйлчилгээ, тээвэр
          зуучлал, карго, аялал жуулчлал зэрэг чиглэлээр үйл ажиллагаа явуулж
          ирсэн ба олон улсын болон дотоодын санхүүгийн хэрэгцээг хялбар,
          найдвартай шийдвэрлэхэд чиглэсэн санхүүгийн байгууллага юм.
        </>
      ),
      about_text_2:
        "Бид Монгол Улс болон ОХУ хоорондын мөнгөн гуйвуулга, валют солилцооны үйлчилгээг хялбар, шуурхай, найдвартай хүргэж ирсэн туршлагатай байгууллага бөгөөд хувь хүн болон байгууллагуудын санхүүгийн хэрэгцээг хангахад анхаарч ажилладаг.",
      stats: {
        since: "оноос",
        transactions: "гүйлгээ",
        clients: "итгэлтэй үйлчлүүлэгч",
      },
      more_btn: "Дэлгэрэнгүй",
      why_title: (
        <span>
          ЯАГААД <span className="gradient-text">OYUNS ALL-IN-ONE</span> ГЭЖ?
        </span>
      ),
      ...
      fallback_biz: {
        ...
        features: [
          "Олон улсын гүйлгээ",
          "Импортын төлбөрийн шилжүүлэг",
          "Бизнес хоорондын төлбөр тооцоо",
        ],
      },
      fallback_receive: {
        ...
        features: [
          "Олон улсын үйлчлүүлэгчдээс төлбөр хүлээн авах",
          "Төлбөрийн найдвартай, шуурхай шилжүүлэг",
        ],
      },
      fallback_send: {
        ...
        features: [
          "Олон улсын худалдааны төлбөр",
          "Импортын барааны инвойс төлөх",
        ],
      },
      ...
      features: {
        flex: {
          title: "Уян хатан",
          desc: "Гадаад болон дотоод гүйлгээний хямд, уян хатан тариф",
        },
        fast: {
        ...
        secure: {
          title: "Баталгаатай",
          desc: "Олон улсын стандартын дагуу аюулгүй үйлчилгээ",
        },
        support: {
          title: "Дэмжлэг",
    ...
    ru: {
      ...
      about_text_1: (
        <>
          <strong className="text-slate-900">OYUNS ALL-IN-ONE</strong>{" "}
          предоставляет услуги международных денежных переводов, финансовых
          услуг, грузоперевозок и туризма с 2018 года. Мы — финансовая
          организация, нацеленная на простое и надежное решение международных и
          местных финансовых потребностей.
        </>
      ),
      about_text_2:
        "Мы имеем большой опыт в предоставлении простых, быстрых и надежных услуг по переводу денег и обмену валюты между Монголией и Россией, уделяя особое внимание финансовым потребностям частных лиц и организаций.",
      stats: {
        since: "года",
      ...
      why_title: (
        <span>
          ПОЧЕМУ <span className="gradient-text">OYUNS ALL-IN-ONE</span>?
        </span>
      ),
      ...
      fallback_receive: {
        ...
        features: [
          "Прием платежей от международных клиентов",
      ...
      fallback_send: {
        ...
        features: [
          "Платежи по международной торговле",
          "Оплата инвойсов за импортные товары",
        ],
      },
      ...
      features: {
        flex: {
          title: "Гибкость",
          desc: "Дешевые и гибкие тарифы на внешние и внутренние транзакции",
        },
        fast: {
          title: "Быстро и надежно",
          desc: "Надежная система мгновенных переводов",
        },
        secure: {
          title: "Гарантировано",
          desc: "Безопасные услуги по международным стандартам",
        },
        support: {
          title: "Поддержка",
          desc: "Высокий уровень обслуживания и надежные транзакции",
        },
      },
    },
  };
  ...
  const fallbackTestimonials = [
    {
      author: "Хэрэглэгч",
      content:
        "Үйлчилгээ нь маш хурдан, найдвартай. Харилцаа хандлага ч гэсэн их найрсаг, тав тухтай байдагт сэтгэл хангалуун байдаг.",
      rating: 5,
    },
    {
      author: "Хэрэглэгч",
      content:
        "Бусад газруудаас илүү шуурхай, найдвартай гэдэгт итгэлтэй болсон. Ирээдүйд улам өргөжиж хөгжөөсэй гэж хүсэж байна!",
      rating: 5,
    },
    {
      author: "Хэрэглэгч",
  ...
  const mongolianIndividual = useDirectus
    ? directusServices
        ...
        .map((s) => ({
          ...
          icon: iconMap[s.icon] || <IndividualIcon />,
        }))
    : [fallbackIndividual];
  ...
  const mongolianBusiness = useDirectus
    ? directusServices
        ...
        .map((s) => ({
          ...
          features: s.features ?? [],
          telegramLink: s.telegram_link,
          icon: iconMap[s.icon] || <BusinessPayIcon />,
        }))
    : [fallbackBusiness];
  ...
  const features = [
    {
      title: content.features.flex.title,
      description: content.features.flex.desc,
      icon: <FlexPriceIcon />,
      color: "from-blue-50 to-indigo-50",
    },
    {
      title: content.features.fast.title,
      description: content.features.fast.desc,
      icon: <SpeedIcon />,
      color: "from-amber-50 to-yellow-50",
    },
    {
      title: content.features.secure.title,
      description: content.features.secure.desc,
      icon: <SecureIcon />,
      color: "from-emerald-50 to-teal-50",
    },
    {
      title: content.features.support.title,
      description: content.features.support.desc,
      icon: <SupportIcon />,
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-lg sm:text-xl mb-10 text-blue-100/80 max-w-2xl mx-auto leading-relaxed flex items-center justify-center gap-2">
              {lang !== "ru" && (
                <span className="font-bold text-white">Илүү </span>
              )}
              <span
                className={
                  lang === "ru"
                    ? "typewriter-ru font-bold text-white"
                    : "typewriter font-bold text-white"
                }
              ></span>
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                href={`/${lang}/exchange`}
                className="group bg-white text-[#2455D8] px-8 py-4 rounded-full font-semibold hover:shadow-xl hover:shadow-white/25 hover:-translate-y-0.5 transition-all duration-300 text-base inline-flex items-center justify-center gap-2"
              >
              ...
              <Link
                href={`/${lang}/services`}
                className="bg-white/10 backdrop-blur-sm text-white px-8 py-4 rounded-full font-semibold hover:bg-white/20 transition-all duration-300 border border-white/20 text-base text-center"
              >
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-5 mb-8">
              {[
                {
                  value: "2018",
                  label: content.stats.since,
                  gradient: "from-[#2455D8] to-[#1b40a8]",
                },
                {
                  value: "15000+",
                  label: content.stats.transactions,
                  gradient: "from-[#1b40a8] to-[#1b40a8]",
                },
                {
                  value: "2500+",
                  label: content.stats.clients,
                  gradient: "from-[#1b40a8] to-indigo-500",
                },
              ].map((stat, i) => (
                <motion.div
                  key={i}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {features.map((feature, index) => (
              <motion.div
                ...
                viewport={{ once: true }}
                className="bg-white rounded-2xl p-6 text-center card-hover border border-gray-200"
              >
                <div
                  className={`inline-flex items-center justify-center w-14 h-14 bg-gradient-to-br ${feature.color} rounded-xl mb-4`}
                >
                  {feature.icon}
                </div>
              ...
              >
                ...
                <div className="relative">
                  ...
                  <div className="text-4xl sm:text-5xl font-extrabold tracking-tight mb-1">
                    {ratesLoading ? (
                      <span className="inline-block w-32 h-12 shimmer rounded-lg" />
                    ) : botRate ? (
                      botRate.buy_rate.toFixed(2)
                    ) : (
                      "—"
                    )}
                  </div>
                ...
                <div className="relative">
                  ...
                  <div className="text-4xl sm:text-5xl font-bold tracking-tight mb-1 text-[#1a1a1a]">
                    {ratesLoading ? (
                      ...
                      businessRate.b2c_rate.toFixed(2)
                    ) : (
                      "—"
                    )}
                  </div>
                ...
                <div className="relative">
                  ...
                  <div className="text-4xl sm:text-5xl font-bold tracking-tight mb-1 text-[#1a1a1a]">
                    {ratesLoading ? (
                      ...
                      businessRate.b2b_rate.toFixed(2)
                    ) : (
                      "—"
                    )}
                  </div>
      ...
      <section className="py-20 bg-white/25 backdrop-blur-[2px]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            ...
            className="text-center mb-14"
          >
            <p className="text-sm font-semibold text-[#2455D8] tracking-wide uppercase mb-2">
              {content.mn_services_sub}
            </p>
            <h2 className="text-3xl sm:text-4xl font-bold text-[#1a1a1a]">
              {content.mn_services_title}
            </h2>
          </motion.div>
      ...
      <section className="py-20 bg-gradient-to-br from-[#2455D8] to-[#1b40a8] text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            ...
            className="text-center mb-14"
          >
            <p className="text-sm font-semibold text-cyan-300 tracking-wide uppercase mb-2">
              {content.ru_services_sub}
            </p>
            <h2 className="text-3xl sm:text-4xl font-extrabold text-white">
              {content.ru_services_title}
            </h2>
          </motion.div>
      ...
      <section className="py-20 bg-white/25 backdrop-blur-[2px]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              : ([
                  {
                    id: 1,
                    title:
                      "OYUNShot №10 . Мөнгө, санхүүгийн суурь мэдлэг олгох 5 ном",
                  ...
                  },
                  {
                    id: 2,
                    title:
                      'OYUNShot №9. Хойш тавилтын зардал: ""Дараа хийнэ ээ…""',
                    slug: "oyunshot-9-procrastination-cost",
                    excerpt:
                      "Хойш тавих зуршил таны санхүүд хэрхэн нөлөөлдөг тухай.",
                  ...
                  },
                  {
                    id: 3,
                    title:
                      "OYUNShot №8. Санхүү + Технологи = FinTech гэж юу вэ?",
                    slug: "oyunshot-8-what-is-fintech",
                    excerpt:
                      "FinTech буюу санхүүгийн технологийн тухай ойлголт.",
          ...
          <div className="text-center mt-10">
            <Link
              href="/blog"
              className="inline-flex items-center gap-2 bg-[#2455D8] text-white px-6 py-3 rounded-full font-semibold hover:shadow-lg hover:-translate-y-0.5 transition-all duration-300 text-sm"
            >
              {content.all_news}
              <svg
                className="w-4 h-4"
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <a
              ...
              className="inline-flex items-center gap-2 bg-white text-[#2455D8] px-8 py-4 rounded-full font-semibold hover:shadow-xl hover:shadow-white/25 hover:-translate-y-0.5 transition-all duration-300 text-base"
            >
