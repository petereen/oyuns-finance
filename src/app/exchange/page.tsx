        ...
        >
          ...
          <div className="mb-10">
            ...
            <p className="text-[#555]">
              OYUNS ALL-IN-ONE өдөр тутмын ханш болон түүхэн мэдээлэл
            </p>
          </div>
          ...
          <div className="mb-12">
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h2 className="text-xl font-bold text-[#1a1a1a]">Хувь хэрэглэгчийн ханш</h2>
                  <p className="text-sm text-[#555]">Авах / Зарах</p>
                </div>
              </div>
              <a
                ...
                className="hidden sm:flex bg-[#2455D8] text-white px-4 py-2 rounded-full text-sm font-semibold hover:bg-blue-700 transition-colors items-center gap-2"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="sm:hidden bg-[#2455D8] text-white p-2 rounded-full hover:bg-blue-700 transition-colors"
                title="oyunsaio_bot"
              >
            ...
            {([7, 30, 90] as const).map((range) => (
              <button
                ...
                className={`px-5 py-2 rounded-full text-sm font-semibold transition-all duration-200 ${
                  timeRange === range
                    ? 'bg-[#2455D8] text-white shadow-lg shadow-blue-900/25'
                    : 'bg-white text-[#555] hover:bg-gray-100 border border-gray-200'
                }`}
              >
                {range} хоног
              </button>
          ...
          <div className="mb-12">
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h2 className="text-xl font-bold text-[#1a1a1a]">BusinessPay ханш</h2>
                  <p className="text-sm text-[#555]">Гүйлгээний ханш</p>
                </div>
              </div>
              <a
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              ...
              >
                ...
                <div className="relative">
                  <div className="flex items-center justify-between mb-3">
                    <p className="text-sm font-medium text-[#555]">Хувь хүнээс байгууллага руу шилжүүлэх ханш</p>
              ...
              >
                ...
                <div className="relative">
                  <div className="flex items-center justify-between mb-3">
                    <p className="text-sm font-medium text-[#555]">Байгууллагаас байгууллага руу шилжүүлэх ханш</p>
